...
#funciones interfaz
def show_popup():
    messagebox.showinfo("Popup", "Las hobras han sido ordenadas.")
...
#modules
label = tk.Label(root, text="Funciones:", font=('Arial',20))
label.place(x=65, y=50, height=50,width=200)

label = tk.Label(root, text="Output:", font=('Arial',20))
label.place(x=550, y=50, height=50,width=200)

btn1 = tk.Button(root, text="1. Mostrar obras", font=('Arial', 20))
btn1.place(x=100, y=100, height=100, width=400)

btn2 = tk.Button(root, text="2. Ordenar obras", font=('Arial', 20), command=show_popup)
btn2.place(x=100, y=250, height=100, width=400)

btn3 = tk.Button(root, text="3. Registrar obra por ver", font=('Arial', 20))
btn3.place(x=100, y=400, height=100, width=400)

btn4 = tk.Button(root, text="4. Registrar obra vista", font=('Arial', 20))
btn4.place(x=100, y=550, height=100, width=400)

btn5 = tk.Button(root, text="5. Sugerir obra por ver", font=('Arial', 20))
btn5.place(x=100, y=700, height=100, width=400)

btn6 = tk.Button(root, text="6. Salir", font=('Arial', 20))
btn6.place(x=100, y=850, height=100, width=400)

textbox = tk.Text(root, height=30, font=('Arial', 20)) 
textbox.place(x=600, y=100, height=850, width=900)
#/modules
